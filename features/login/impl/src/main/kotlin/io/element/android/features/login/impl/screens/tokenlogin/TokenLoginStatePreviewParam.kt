...
open class TokenLoginStatePreviewParam : PreviewParameterProvider<TokenLoginState> {
    override val values: Sequence<TokenLoginState>
        get() = sequenceOf(
            aTokenLoginState(),
            aTokenLoginState(loginAction = AsyncData.Failure(AuthenticationException.Generic("M_FORBIDDEN: Invalid login token"))),
...
fun aTokenLoginState(
    ...
    loginAction: AsyncData<SessionId> = AsyncData.Loading(),
